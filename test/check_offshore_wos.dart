...
void main() async {
  ...
  final res = await http.get(Uri.parse('http://94.136.185.87:16000/offshore/workorder/assets?limit=100'), headers: headers);
  final data = jsonDecode(res.body);
  print('Total in /offshore/workorder/assets: ${data['total']}');
